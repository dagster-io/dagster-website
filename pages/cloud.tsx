  ...
  render() {
    return (
      ...
      <p className="text-blue-900 medium flex justify-left">
        We are building a hosted version of Dagster and are accepting waitlist sign ups!
        We look forward to partnering with you to make Dagster Cloud the fastest
        way for teams to orchestrate and operate data pipelines.</p>
