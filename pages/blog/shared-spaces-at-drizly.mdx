...
Thinking through our workflows, we decided on 4 key deployments within our Dagster project, each of which is tied to a stage in the development lifecycle and a deployment target for running Dagster, whether on a local machine or on AWS:

<table style={{border: "1px solid"}}>
  <tr style={{border: "1px solid"}}>
    <th style={{background: "#efefef", "border-right": "1px solid", "padding": "5px 5px 5px 5px"}}>Deployment</th>
    <th style={{background: "#efefef", "padding": "5px 5px 5px 5px"}}>Location</th>
  </tr>
  <tr>
    <td style={{"border-right": "1px solid", "padding": "5px 5px 5px 5px"}}>local</td>
    <td style={{"padding": "5px 5px 5px 5px"}}>Local, Python virtual environment</td>
  </tr>
  <tr>
    <td style={{"border-right": "1px solid", "padding": "5px 5px 5px 5px"}}>docker compose</td>
    <td style={{"padding": "5px 5px 5px 5px"}}>Local, Docker</td>
  </tr>
  <tr>
    <td style={{"border-right": "1px solid", "padding": "5px 5px 5px 5px"}}>dev</td>
    <td style={{"padding": "5px 5px 5px 5px"}}>AWS dev account</td>
  </tr>
  <tr>
    <td style={{"border-right": "1px solid", "padding": "5px 5px 5px 5px"}}>prod</td>
    <td style={{"padding": "5px 5px 5px 5px"}}>AWS prod account</td>
  </tr>
</table>
...
<table style={{border: "1px solid"}}>
  <tr style={{border: "1px solid"}}>
    <th style={{background: "#efefef", "border-right": "1px solid", "padding": "5px 5px 5px 5px"}}>Deployment</th>
    <th style={{background: "#efefef", "padding": "5px 5px 5px 5px"}}>Modes</th>
    <th style={{background: "#efefef", "padding": "5px 5px 5px 5px"}}>Launcher</th>
    <th style={{background: "#efefef", "padding": "5px 5px 5px 5px"}}>Workspaces</th>
...
Our two AWS deployments (dev and prod) both take advantage of the Dagster ECS Launcher.
