...
![](https://miro.medium.com/max/1400/1*KrB-zIuyUG_Xf8USbVptIw.png)
...
![](https://cdn-images-1.medium.com/max/2880/1*Xe-s_p-g3ugkZBGC2p--WQ.png)
...
Feel free to look at our [code](https://github.com/dagster-io/dagster), our revamped [documentation](https://docs.dagster.io/), and join our [Slack](https://join.slack.com/t/dagster/shared_invite/enQtNjEyNjkzNTA2OTkzLTI0MzdlNjU0ODVhZjQyOTMyMGM1ZDUwZDQ1YjJmYjI3YzExZGViMDI1ZDlkNTY5OThmYWVlOWM1MWVjN2I3NjU). There is a lot of work to do to make developing, operating, debugging, and extending data applications feel more modern. If you are also passionate about this problem, consider working with the team behind Dagster, [Elementl](https://www.elementl.com/).
