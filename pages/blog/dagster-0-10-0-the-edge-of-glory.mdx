...
* *Sensors:* Dagster now supports sensors (event-based schedulers) managed by our scheduler process. Dagster sensors are fault-tolerant, exactly-once, and supported by best-in-class operational tools.
