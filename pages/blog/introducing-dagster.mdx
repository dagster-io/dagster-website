...
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <Microlink url="https://twitter.com/BigDataBorat/status/306596352991830016" />
</div>
...
<Microlink url="https://overreacted.io/react-as-a-ui-runtime/" style={{ maxWidth: '100%' }} />
...
Dagster allows the user to define an abstract graph of functional computations, which we call solids. The actual business logic of a solid can be defined and executed within any tool, as long as they are annotated and structured to conform to the Dagster API. Solids’ inputs and outputs are connected to each by data dependencies, which form the graph.
...
<Microlink
  url="https://www.dataengineeringpodcast.com/datakitchen-dataops-with-chris-bergh-episode-26/"
  style={{ maxWidth: '100%' }}
/>
