...
After a brief intro from Nick Schrock ([@schrockn](https://twitter.com/schrockn)), the founder of Elementl, Max Gasner ([@gasnerpants](https://twitter.com/gasnerpants)) led a short tour of some of the highlights from our 0.9.0 release, “Laundry Service”. [Slide deck](https://docs.google.com/presentation/d/17ts4HfRUEqLbBF52DZ66G1QHI1PutK2MnY_cnlTWbug/edit#slide=id.g9380d0b962_0_0).
