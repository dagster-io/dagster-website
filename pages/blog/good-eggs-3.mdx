...
We do this using a composite solid:

<p align="center">
  <img
    src="/posts/good-eggs-3/mode_graph_composite.png"
...
In general, we prefer not to run notebooks in production, but in this case, it’s the easiest way to create the visualization we need. We wrap the notebook in a Dagster solid using [Dagstermill](https://docs.dagster.io/_apidocs/libraries/dagstermill) , an optional library built on top of Dagster and [papermill](https://github.com/nteract/papermill) that lets notebooks be parameterized and orchestrated alongside all the other steps of our pipeline.
...
<p align="center">
  <img
    src="/posts/good-eggs-3/model_count.png"
    alt="Our dbt model count over time."
    width="500px"
  />
</p>
