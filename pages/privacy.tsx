  ...
  render() {
    return (
      <div className="flex flex-col p-4 m-10 bg-gradient-to-r from-blue-200 to-blue-300 rounded-md">
        ...
        <p className="text-blue-900 justify-left pb-2">
          Sometimes we collect Personal Information automatically when an individual interacts with
          our Services and sometimes we collect Personal Information directly from an individual. At
          times, we may collect Personal Information about an individual from other sources and
          third parties, even before our first direct interaction.
          <br></br>
          <br></br>
          <u>Personal Information Collected from Site Visitors</u>
          <br></br>
          <br></br>
        ...
        <ul className="list-disc list-inside text-blue-900 justify-left pb-2">
          <li>
            Fulfill or meet the reason the information was provided, such as to fulfill our
            contractual obligations, to deliver the Services you have requested;
          </li>
          <li> Manage our organization and its day-to-day operations; </li>
          <li>
            Communicate with individuals, including via email, text message, social media and/or
            telephone calls;
          </li>
          <li>
            Market our Services to individuals, including through email, direct mail, phone or text
            message;
          </li>
          <li>
            Administer, improve and personalize our Services, including by recognizing an individual
            and remembering their information when they return to our Site;
          </li>
          <li> Process payment for our Services; </li>
          <li>
            Facilitate client benefits and services, including customer support through our command
            center services;
          </li>
          ...
          <li>
            Improve and customize our Services to address the needs and interests of our client base
            and other individuals we interact with;
          </li>
          <li>
        ...
        <p className="text-blue-900 justify-left pb-2">
          <br></br>
          Where an individual chooses to contact us, we may need additional information to fulfill
          the request or respond to inquiries. We may provide additional privacy disclosures where
          the scope of the inquiry/request and/or Personal Information we require fall outside the
          scope of this Privacy Notice. In that case, the additional privacy disclosures will govern
          how we may process the information provided at that time.
        </p>
        ...
        <p className="text-blue-900 justify-left pb-2">
          If you are a resident of the State of Nevada, Chapter 603A of the Nevada Revised Statutes
          permits a Nevada resident to opt out of future sales of certain covered information that a
          website operator has collected or will collect about the resident. Although we do not
          currently sell covered information, please contact us at privacy@elementl.com to submit
          such a request.
        </p>
        ...
        <p className="text-blue-900 justify-left pb-2">
          Our Services are not directed to, and we do not intend to, or knowingly, collect or
          solicit Personal Information from children under the age of 13. If an individual is under
          the age of 13, they should not use our Services or otherwise provide us with any Personal
          Information either directly or by other means. If a child under the age of 13 has provided
          Personal Information to us, we encourage the child’s parent or guardian to contact us to
          request that we remove the Personal Information from our systems. If we learn that any
          Personal Information we collect has been provided by a child under the age of 13, we will
        ...
        <p className="text-blue-900 justify-left pb-2">
          Our Site and Services may include links to third-party websites, plug-ins and
          applications. Except where we post, link to or expressly adopt or refer to this Privacy
          Notice, this Privacy Notice does not apply to, and we are not responsible for, any
          Personal Information practices of third-party websites and online services or the
          practices of other third parties. To learn about the Personal Information practices of
          third parties, please visit their respective privacy notices.
        </p>
        ...
        <p className="text-blue-900 justify-left pb-2">
          We will update this Privacy Notice from time to time. When we make changes to this Privacy
          Notice, we will change the date at the beginning of this Privacy Notice. If we make
          material changes to this Privacy Notice, we will notify individuals by email to their
          registered email address, by prominent posting on this Site or our Services, or through
          other appropriate communication channels. All changes shall be effective from the date of
